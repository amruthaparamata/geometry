...
\end{align}
Radius of circle with centre $\vec{O}$ is
\begin{align}
             R = OA
               = \frac{\sqrt{4514}}{12}
\end{align}
$\therefore$
The vector equation of circle is
\begin{align}
  \vec{r(t)} = \left(\frac{-53}{12} + \frac{\sqrt{4514}}{12}cos(t)\right)\vec{\hat{i}} + \left(\frac{5}{12} + \frac{\sqrt{4514}}{12}sin(t)\right)\vec{\hat{j}}
\end{align}
